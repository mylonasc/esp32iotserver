...
private:
  ...
  static void appendSensorRow_(String& html, const SoilMoistureController::Reading& r, uint32_t now);
  static void appendSensorJson_(String& json, const SoilMoistureController::Reading& r, uint32_t now);
};
